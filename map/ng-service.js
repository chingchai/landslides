...
.service('geoService', function($http) {
    return {
        ...
        getWfs: function() {
            ...
            var data =  'http://www3.cgistln.nu.ac.th/geoserver/ows?service=WFS&version=2.0.0&request=GetFeature&typeName=lsnanbasin:village_detect_final&maxFeatures=100&outputFormat=application%2Fjson';
